...
def main():
    ...
    for i, data in enumerate(dataset):
        ...
        fake_image, warped_cloth, refined_cloth = model(Variable(data['label'].cpu()), Variable(data['edge'].cpu()), Variable(img_fore.cpu()), Variable(
            mask_clothes.cpu()), Variable(data['color'].cpu()), Variable(all_clothes_label.cpu()), Variable(data['image'].cpu()), Variable(data['pose'].cpu()), Variable(data['image'].cpu()), Variable(mask_fore.cpu()))
