...
def get_arguments():
    ...
    parser.add_argument("--gpu", type=str, default='', help="choose gpu device.")
    ...
    parser.add_argument("--logits", action='store_true', default=True, help="whether to save the logits.")
...
def main():
    ...
    with torch.no_grad():
        for idx, batch in enumerate(tqdm(dataloader)):
            ...
            if args.logits:
                logits_result_path = os.path.join(args.output_dir.replace('test_label','temp'), img_name[:-4] + '.npy')
